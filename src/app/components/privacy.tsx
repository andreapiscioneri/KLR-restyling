        ...
        <div className="max-w-4xl mx-auto px-8">
          <AnimatedSection>
            ...
            <div className="mt-14 rounded-[40px] p-10 md:p-14 bg-white border border-black/5" style={softShadow}>
              ...
              <div className="mt-10 space-y-8" style={{ fontSize: "1rem", lineHeight: 1.75 }}>
                <div>
                  ...
                  <p className="text-black tracking-tight">
                    ...
                    <a href="https://www.klr-europe.com" className="text-[#2E2784] hover:text-[#2E2784]/70 transition-colors">www.klr-europe.com</a>
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-black tracking-tight">
                    ...
                    <a href="mailto:info@klr-europe.com" className="text-[#2E2784] hover:text-[#2E2784]/70 transition-colors">info@klr-europe.com</a>. We respond within 30 days.
                  </p>
                </div>
