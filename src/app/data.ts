...
export const fallbackPosts = [
  { id: 4822, slug: "licensed-to-connect-key-takeaways-licensing-expo-2025", title: "Licensed to Connect: Key Takeaways from Licensing Expo 2025 on Reinventing Loyalty in Grocery and Petrol Retail", date: "2026-04-23", excerpt: "At the recent Licensing Expo in Las Vegas, one theme stood out clearly: the future of retail is not simply digital or physical—it's experiential, emotional, and increasingly hybrid.", img: `${CDN}/2025/08/Spar-TZ_RedBull-cover-circle.jpg`, link: "https://klr-europe.com/licensed-to-connect-key-takeaways-licensing-expo-2025/", category: "Retail Trends", contentHtml: `
