...
export const leadership = [
  { id: "antonio-finazzi", name: "Antonio Finazzi", role: "CEO & Founder", img: "/team/KLR-Antonio-fondo-giallo.png", bio: "Antonio founded KLR in 2015 with a vision to design emotional loyalty across Europe. Three decades of retail and petrol strategy built on relationships.", quote: "Loyalty is never transactional. It's human.", linkedin: "https://www.linkedin.com/search/results/all/?keywords=Antonio%20Finazzi%20KLR" },
  { id: "stefano-finazzi", name: "Stefano Finazzi", role: "CMO & Founder", img: "/team/Stefano-FINAZZI.png", bio: "Stefano shapes the creative and marketing vision of KLR — from campaign concept through every retail touchpoint.", quote: "We deliver 6 million moments of joy a year — every single one matters.", linkedin: "https://www.linkedin.com/search/results/all/?keywords=Stefano%20Finazzi%20KLR" },
  { id: "sebastjan-kocjancic", name: "Sebastjan Kocjančič", role: "COO", img: "/team/Sebstjan-Kocjancic.png", bio: "Sebastjan runs operations across 10 European locations. Procurement, warehousing, distribution — the backbone behind every flawless rollout.", quote: "Every shopper deserves a reason to come back.", linkedin: "https://www.linkedin.com/search/results/all/?keywords=Sebastjan%20Kocjan%C4%8Di%C4%8D%20KLR" },
  { id: "olga-wojcik", name: "Olga Wojcik", role: "Head of Corporate Sales", img: "/team/Olga-WOJCIK.png", bio: "Olga drives corporate sales across the KLR client portfolio, turning ambitious briefs into long-term partnerships.", quote: "Sales is listening before selling.", linkedin: "https://www.linkedin.com/search/results/all/?keywords=Olga%20Wojcik%20KLR" },
  { id: "marta-marga", name: "Marta Marga", role: "Head of Marketing", img: "/team/Marta-MARGA.png", bio: "Marta leads marketing, content and communications — the voice of KLR across every channel.", quote: "Good marketing feels like good storytelling.", linkedin: "https://www.linkedin.com/search/results/all/?keywords=Marta%20Marga%20KLR" },
  { id: "jan-sahbaz-pergar", name: "Jan Šahbaz Pergar", role: "Head of Development", img: "/team/Jan-SAHBAZ-PERGAR.png", bio: "Jan leads product and technology development, including KLR's proprietary campaign management software.", quote: "Great software makes complex things feel simple.", linkedin: "https://www.linkedin.com/search/results/all/?keywords=Jan%20Sahbaz%20Pergar%20KLR" },
  { id: "riccardo-fogazzi", name: "Riccardo Fogazzi", role: "Head of Campaigns & Stock Management", img: "/team/Riccardo-FOGAZZI.png", bio: "Riccardo oversees campaign execution and stock management across 20+ markets.", quote: "Plan for the edge cases — delight lives in the details.", linkedin: "https://www.linkedin.com/search/results/all/?keywords=Riccardo%20Fogazzi%20KLR" },
  { id: "nina-bjelivuk", name: "Nina Bjelivuk", role: "Head of Logistics", img: "/team/Nina-BJELIVUK.png", bio: "Nina orchestrates logistics across Europe — from port to pallet to final store.", quote: "Loyalty only works when the reward arrives on time.", linkedin: "" },
  { id: "natalia-molchanova", name: "Natalia Molchanova", role: "Head of Corporate Communication", img: "/team/Natalia-MOLCHANOVA.png", bio: "Natalia shapes KLR's corporate voice, partnerships and external communications.", quote: "Clear words build loyal relationships.", linkedin: "https://www.linkedin.com/search/results/all/?keywords=Natalia%20Molchanova%20KLR" },
  { id: "team-design", name: "Design Studio", role: "Creative & Product Design", img: images.tailorMade, bio: "Our in-house design studio develops packaging, POSM and campaign identities tailored to every retailer and brand.", quote: "Design is how people fall in love with a campaign.", linkedin: "" },
  { id: "team-analytics", name: "Analytics Team", role: "Measurement & Insight", img: images.servicesInfographic, bio: "KLR's analytics team delivers custom metrics, KPI dashboards and post-campaign insights.", quote: "Numbers tell us what worked — and what to try next.", linkedin: "" },
